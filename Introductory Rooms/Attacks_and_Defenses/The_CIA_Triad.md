...
Room: [CIA Triad](https://tryhackme.com/room/theciatriad)

<img width="1897" height="387" alt="image" src="https://github.com/user-attachments/assets/3823fcce-e89d-4c88-88f8-a3ee045a239d" />

## Understanding the CIA Triad

Protecting digital data has become a core requirement for government, organizations, and individuals.
...
Now, let's consider a digital world example. Suppose you initiate a bank transfer to an account using your mobile device. Before the transaction completes, someone intercepts it and modifies the receiving account information. This results in the amount getting transferred where it wasn't supposed to. This breaches the integrity. 
...
<img width="388" height="303" alt="image" src="https://github.com/user-attachments/assets/aaf959fa-084b-4bf6-b5ff-6d1bd02f1921" />
